...
if __name__ == "__main__":
    ...
    user_base1 = float(input('Please input a base for triangle 1: '))
    user_height1 = float(input('Please input a height for triangle 1: '))
    triangle1.set_base(user_base1)
    triangle1.set_height(user_height1)

    # We could also get user_base1 as triangle1.set_base() = float(input('Please input a bas for triangle 1: '))

    # TODO: Read and set base and height for triangle2 (use set_base() and set_height())
    user_base2 = float(input('Please input a base for triangle 2: '))
    user_height2 = float(input('Please input a height for triangle 2: '))
