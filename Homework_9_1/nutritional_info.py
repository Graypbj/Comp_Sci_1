class FoodItem:
    ...
    def __init__(self, name='food', fat=0, carbs=0, protein=0):
        self.name = name
        self.fat = fat
        self.carbs = carbs
...
if __name__ == "__main__":
    ...
    if item_name == 'Water' or item_name == 'water':
        ...
        amount_fat = float(input('Enter the amount of fat (in grams): '))
        amount_carbs = float(input('Enter the amount of carbs (in grams): '))
        amount_protein = float(input('Enter the amount of protein (in grams): '))
        num_servings = float(input('Enter the number of servings: '))
